	...
	<div class = "container">
		...
		<div class="right">
			<form method = "POST" action = "processa.php">
				...
				<input type= "text" name = "nome" placeholder = "Digite o nome do Médico / Especialista" required></br></br>

				<label>Data e Hora: </label>
				<input type= "datetime-local" name = "email" placeholder = "Digite a data e hora"></br></br>

				<label>Sintomas: </label>
				<input type= "text" name = "senha" placeholder = "Digite os Sintomas"></br></br>
		...
		<div>
			<h1 class="h1 h1_2"> Lista de Exames e Consultas</h1>
